...
def confirm_ingredients():  # String methods
    ...
    print(ingredients.replace(f'{ingredient_1}', 'butter'))
    ...
    print(ingredients.count(f'{ingredient_1}'))
    ...
    ingredients = ingredients.replace(f'{ingredient_1}', 'butter')
...
def favorite_bake():  # User Input/Type conversion
    ...
    print(f'We recommend you eat {baked_good}s at least {{intfrequency * 2}} times a month!')
